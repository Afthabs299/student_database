...
cf_bg = '#4A7A8C' # bg color for the center_frame
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM", font=headlabelfont, bg='LightSkyBlue1').pack(side=TOP, fill=X)
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='LightBlue4', fg='LightCyan').pack(side=TOP, fill=X)
